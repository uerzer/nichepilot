# Poured Content Plan — 100 topics in 5 clusters

Rules: work top to bottom within a cluster before opening a new one. `$` = buyer intent (affiliate slots required). Check off with `[x]` when published. Never repeat a slug.

## Cluster 1: Beginner foundations (20)
- [x] how-to-start-resin-art
...
## Cluster 2: Techniques (20)
- [x] ocean-resin-art-tutorial
...
- [ ] resin-edges-clean-finishing
- [ ] making-resin-trays-serving-boards ($)

## Cluster 3: Troubleshooting (20)
- [x] resin-art-bubbles-fix
- [x] sticky-resin-fix
- [x] resin-safety-guide
- [ ] resin-yellowing-causes-prevention
- [ ] cloudy-resin-causes-fixes
- [ ] resin-cracks-and-how-to-avoid
- [ ] amine-blush-explained-fix
- [ ] resin-fish-eyes-craters-fix
- [ ] dust-in-resin-prevention-removal
- [ ] resin-shrank-pulled-from-edges
- [ ] over-torched-resin-repair
- [ ] pigment-separation-why-colors-sink
- [ ] resin-stuck-in-mold-removal
- [ ] warping-resin-pieces-fix
- [ ] soft-spots-cured-resin-repair
- [ ] resin-smells-after-curing-fix
- [ ] why-resin-cured-too-fast-exotherm
- [ ] white-spots-in-resin-causes
- [ ] repairing-scratched-resin-surfaces
- [ ] salvaging-failed-pours-10-ideas
...
- [ ] resin-ring-dishes-and-trinket-trays
- [ ] resin-wall-clock-diy ($)
- [ ] resin-cutting-board-food-safety
...
## Cluster 5: Buying guides (20, all $)
- [ ] best-resin-for-beginners-ranked
- [ ] best-uv-resin-for-jewelry
- [ ] best-deep-pour-epoxy
- [ ] best-silicone-mold-sets
- [ ] best-mica-powder-sets
- [ ] best-alcohol-inks-for-resin
- [ ] best-heat-guns-for-resin-art
- [ ] best-respirators-under-50
- [ ] best-mixing-cups-and-tools-sets
- [ ] best-pressure-pots-for-resin
- [ ] best-vacuum-chambers-small-shop
- [ ] best-glitter-for-resin-that-wont-sink
- [ ] best-dried-flowers-for-resin
- [ ] best-mold-release-sprays
- [ ] best-polishing-kits-resin
- [ ] best-craft-scales-01g
- [ ] best-work-mats-silicone-large
- [ ] best-storage-for-resin-supplies
- [ ] best-beginner-kits-under-50
- [ ] resin-brand-showdown-top-5-tested
